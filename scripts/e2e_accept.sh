...
echo "=================================================================="
run_case "rs->rs 全开"      rs rs "--pad-mode bucket --min-enc gcm --session-token" "--enc-algo 2"
run_case "rs->go 全开"      rs go "--pad-mode bucket --min-enc gcm --session-token" "--enc-algo 2"
